...
Future<String?> showCityPickerDialog(BuildContext context) {
  return showDialog<String>(
    ...
    builder: (dialogContext) {
      return const _CityPickerContent();
    },
  );
}

class _CityPickerContent extends StatefulWidget {
  const _CityPickerContent();

  @override
  State<_CityPickerContent> createState() => _CityPickerContentState();
}

class _CityPickerContentState extends State<_CityPickerContent> {
  late Future<List<CityModel>> _citiesFuture;

  @override
  void initState() {
    super.initState();
    _citiesFuture = ServiceLocator.citiesService.getCities();
  }
