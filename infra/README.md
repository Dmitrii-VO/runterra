...
- [ ] Завершение тренировки — возможность явно завершить активную пробежку
- [x] Редактирование профиля — экран/форма изменения данных пользователя
- [ ] Выбор города — настройка города пользователя (без привязки к чату города)
- [ ] События для примера — добавить примеры событий (данные/демо)

**Чаты**
- [ ] Удалить чат города — оставить только чат клуба; вместо города сделать вкладки: **Личные** / **Клуб** / **Тренер**

**Карта и трекинг**
- [ ] Трекинг пробежки на карте — отображение маршрута в реальном времени во время бега (локация, интеграция с часами, опционально — показатели в реальном времени)
- [ ] Кнопка «Найти клуб» — переход на карту с отображением клубов
- [ ] Кнопка «Создать клуб» — сделать функциональной (создание клуба)
- [ ] Убрать с карты фильтры «сегодня / неделя / мой клуб» и аналогичные
